...
#	return isflare
	...
	istart_i = np.array(istart_i, dtype='int') -1 #we add an extra point for better energy estimation
...
if __name__ == "__main__":
	...
	try:
		opts, args = getopt.getopt( sys.argv[1:], "hmo:n:s:p:f:",\
			["help", "magnitudes", "outfile=", "flarepoints=","sigma=", "period=","fwhm=","degree=","debug", "hardcopy", "nofit", "no-fit"])
